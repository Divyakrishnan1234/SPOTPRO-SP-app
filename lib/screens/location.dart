  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading
          ...
          searchBarHintColor: Colors.deepPurple.shade100,
          mapLoadingBackgroundColor: Colors.deepPurple.shade100,
          markerIcon: Icon(Icons.location_on,
            size: 50,
            color: Colors.red,
          ),
          selectLocationButtonText: 'Set Location',
          locationButtonBackgroundColor: Colors.deepPurple,
          zoomButtonsBackgroundColor: Colors.deepPurple,
          ...
          onPicked: (pickedData) {
            ...
            if(_selectedLocation != null)_updateUserLocation(pickedData.address);
