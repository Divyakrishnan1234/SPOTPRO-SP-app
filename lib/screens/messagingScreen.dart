          ...
          return snapshot.hasData?Expanded(
            child: ListView.builder(
                ...
                itemBuilder: (context,index){
                  return MessageTile (message:snapshot.data!.docs[index]["message"],sendByMe:snapshot.data!.docs[index]["sendBy"]==ap.uid, type: snapshot.data!.docs[index]["type"]);
                }),
          ): Container();
        });
  }
